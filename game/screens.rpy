...
#        style_prefix "navigation"
        ...
        # https://www.renpy.org/doc/html/screen_python.html#renpy.get_screen
        if renpy.get_screen("main_menu"):
            # https://lemmasoft.renai.us/forums/viewtopic.php?t=30122#p354282
            # if renpy.current_screen().screen_name[0] == "main_menu":
            style_prefix "main_navigation"
#            properties gui.button_properties("main_navigation_button")
        else:
...
#            properties gui.button_properties("game_navigation_button")
        ...
        if main_menu:
            ...
            # https://lemmasoft.renai.us/forums/viewtopic.php?t=30122#p354282
#            textbutton _(renpy.current_screen().screen_name[0]) action Start()
...
style main_navigation_button_text:
    properties gui.button_text_properties("main_navigation_button")
        ...
        vbox:
            ...
            hbox:
                ...
                vbox:
                    style_prefix "pref"
                    label _("Language")
                    textbutton "Ру́сский язык" action Language(None)
                    textbutton "Белару́ская мо́ва" action Language("Belarusian")
