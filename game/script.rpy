...
label start:
    ...
    alesya "Они с братом Миколой в соседней хате жили. Хата была добрая, семья работящие"
    ...
    raya "Скоро стемнеет, Микола встретит нас!"
    ...
    menu:
        "Подарить венок Миколе или оставить себе?"
        # Оставить
        "Спасибо!":
            # Что подарили венок Николаю
            $ nikolai_chosen = False

            alesya "Микола корешок мой детский, боюсь нелепо это будет, если венок ему отдам. Поймут ещё не так..."
            # Прыгаем на ночное похищение лавки (Рая хочет свести с Яном)
            jump lava
        # Подарить
        "Спасибо, Микола! Возьми мой венок?":
            # Что подарили венок Николаю
            $ nikolai_chosen = True

            alesya "На мгновение показалось, что Микола растерялся... Странно, я же его с детства знаю, чего тут такого, или подумал что?"
...
label vech:
    ...
    if not yan_chosen:
        ...
        if nikolai_chosen:
            ...
            alesya "Хорошо, что Микола с нами был. Заступился за меня, долго Ян жалеть о шалости своей будет!"
...
label army:
    ...
    menu:
        ...
        "Попрошу Раечку. Ей ничаго не страшно":
            jump raya
        # Попросить Миколу
        "Попрошу Миколу, он всегда рядом и рад помочь":
            alesya "Микола не смог мне отказать, обещался всё передать. Сердечко бъётся..."
